     ...
     <sql:query var="grant" dataSource="${con}">
	            SELECT count(f_id) as fcount
                 FROM users,sys_function
                   where u_grant regexp 'C3' and u_id=?;
...
<div id="container">
	...
	<div id="main">
		...
		<!-- 可编辑区 -->
	 	服务管理->服务处理
		<p>
		<html:form action="/serviceManage/services?url=ser_showHandle" method="post">
  ...
  <tr>
    <td width="84" class="formTitleTd">客户</td>
    <td width="148" width="207" class="formTdMouseOut" onMouseOver="this.className='formTdMouseOver'" 
		 onMouseOut="this.className='formTdMouseOut'">
    <html:text property="customer.cusName"></html:text>
      
    </td>
    <td width="38" class="formTitleTd">概要</td>
    <td width="207" width="207" class="formTdMouseOut" onMouseOver="this.className='formTdMouseOver'" 
		 onMouseOut="this.className='formTdMouseOut'">
      <html:text property="services.serContext"></html:text>
     </td>
    <td width="72" class="formTitleTd">服务类型</td>
    <td width="51" width="207" class="formTdMouseOut" onMouseOver="this.className='formTdMouseOver'" 
		 onMouseOut="this.className='formTdMouseOut'">
  ...
  <tr>
    ...
    <td colspan="3" width="207" class="formTdMouseOut" onMouseOver="this.className='formTdMouseOver'" 
		 onMouseOut="this.className='formTdMouseOut'">
 ...
 <table width="700" height="56" border="1">
  <tr class="listTitleTR">
   ...
   <c:forEach var="serRow" items="${services.rows}">
    ...
    ${serRow.ser_pubtime }
     ...
     <td>
       <c:if test="${serRow.ser_status==2}">
     <a href="ser_doHandle.jsp?serID=${serRow.ser_id}">处理</a>
     </c:if>
    ...
    <td colspan="8">
	      ...
	      <input type="hidden" name="url" value="serviceManage/ser_showHandle.jsp"/>
  ...
  <logic:iterate id="ser" name="list" indexId="i">
    ...
    <bean:write name="ser" property="serPubtime" format="yyyy-MM-dd"/>
     ...
     <td>
       <c:if test="${ser.serStatus==2}">
       <a href="ser_doHandle.jsp?serID=${ser.serId}">处理</a>
       </c:if>
