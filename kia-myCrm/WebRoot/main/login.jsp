...
#globallink{
	...
	background:url(../images/logo.jpg) no-repeat;	/* 添加banner图片 */
}
#globallink ul{
	list-style:none;
	position:absolute;
	left:700px; top:35px;				/* 调整菜单文字的位置 */
...
<body>
   <form action="login" method="post">
   		...
   		<p>&nbsp;</p>
   		<p><center><h1>
   		  T02客户关系管理系统内测版 beta1.0
   		</h1></center></p>
   		<table align="center" bgcolor="#99FFCC">
<tr>
            	<td width="39" class="formTitleTd"><font size="-1">用户名</font></td>
            ...
            <tr>
            	<td class="formTitleTd" align="center"><font size="-1">密码</font></td>
          ...
          <tr><td colspan="2">
          <a target="_top" href="tencent://message/?uin=249750689&Site=mycms&Menu=yes">联系管理员</a>
          </td></tr>
            <tr bgcolor="#FFCCCC">
