...
public interface IMapper<T>{
	...
	public ArrayList<T> selectUnion(ArrayList<T> querys,PageBounds page) throws Exception;
	...
	public ArrayList<T> selectViewUnion(ArrayList<T> querys,PageBounds page) throws Exception;
