...
var Obj_Display = $G(ObjectId).style.display;
	...
	$G(parentId).innerHTML = "<a href=Orders.jsp# onClick=javascript:Effect('"+ObjectId+"','"+parentId+"');>-</a>"
	}else{ 
      ...
      <td>
		<div id="control">
		  <table class=title width="100%"  border="0" cellpadding="0" cellspacing="0">
		    <tr>
				  <td width="100%" align="center" class="tabTit" ><li id="testtab" style="float:right"><a href="Orders.jsp#" onClick="Effect('test',this.parentNode.id);" >+</a> </li><li style="float:left"><a href="Orders.jsp#" onClick="Effect('test');" class="testLink">我的信息</a></li></td>
		    </tr>
		  </table>
		</div>
		...
		<div id="control">
		  <table width="100%"  border="0" cellpadding="0" cellspacing="0">
		    <tr>
		      <td width="100%" align="center" class="tabTit" ><li id="test1tab" style="float:right"><a href="Orders.jsp#" onClick="Effect('test1',this.parentNode.id);" >+</a> </li><li style="float:left"><a href="Orders.jsp#" onClick="Effect('test1');" class="testLink">收货地址</a></li></td>
		    </tr>
		  </table>
		</div>
		...
		<div id="control">
		  <table width="100%"  border="0" cellpadding="0" cellspacing="0">
		    <tr>
		      <td width="100%" align="center" class="tabTit" ><li id="test2tab" style="float:right"><a href="Orders.jsp#" onClick="Effect('test2',this.parentNode.id);" >+</a> </li><li style="float:left"><a href="Orders.jsp#" onClick="Effect('test2');" class="testLink">我的买卖</a></li></td>
		    </tr>
		  </table>
		</div>
