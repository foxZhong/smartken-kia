...
namespace myQQ
{
    class ConfigHelper
    {
        ...
        public static string getServerHost() {
            ...
            string key = "host";
            string noText = ".";
            string iniFilePath =System.Environment.CurrentDirectory+"/system.ini";
            return ReadIniData(section,key,noText,iniFilePath);
        }

        public static bool setServerHost(String value)
        {
            string section = "server";
            string key = "host";
            string iniFilePath = System.Environment.CurrentDirectory + "/system.ini";
        ...
        public static bool setDbName(String value)
        {
            string section = "server";
            string key = "dbname";
            string iniFilePath = System.Environment.CurrentDirectory + "/system.ini";
