...
var Obj_Display = $G(ObjectId).style.display;
	...
	$G(parentId).innerHTML = "<a href=AddAddress.jsp# onClick=javascript:Effect('"+ObjectId+"','"+parentId+"');>-</a>"
	}else{ 
      ...
      <td>
		<div id="control">
		  <table class=title width="100%"  border="0" cellpadding="0" cellspacing="0">
		    <tr>
				  <td width="100%" align="center" class="tabTit" ><li id="testtab" style="float:right"><a href="AddAddress.jsp#" onClick="Effect('test',this.parentNode.id);" >+</a> </li><li style="float:left"><a href="AddAddress.jsp#" onClick="Effect('test');" class="testLink">我的信息</a></li></td>
		    </tr>
		  </table>
		</div>
		...
		<div id="control">
		  <table width="100%"  border="0" cellpadding="0" cellspacing="0">
		    <tr>
		      <td width="100%" align="center" class="tabTit" ><li id="test1tab" style="float:right"><a href="AddAddress.jsp#" onClick="Effect('test1',this.parentNode.id);" >+</a> </li><li style="float:left"><a href="AddAddress.jsp#" onClick="Effect('test1');" class="testLink">收货地址</a></li></td>
		    </tr>
		  </table>
		</div>
		...
		<div id="control">
		  <table width="100%"  border="0" cellpadding="0" cellspacing="0">
		    <tr>
		      <td width="100%" align="center" class="tabTit" ><li id="test2tab" style="float:right"><a href="AddAddress.jsp#" onClick="Effect('test2',this.parentNode.id);" >+</a> </li><li style="float:left"><a href="AddAddress.jsp#" onClick="Effect('test2');" class="testLink">我的买卖</a></li></td>
		    </tr>
		  </table>
		</div>
...
<%
	...
	if(session.getAttribute("user")!=null){
		info=(UserInfo)session.getAttribute("user");
	}
	DeliveryInfoDao infoDao = new DeliveryInfoDaoImpl();
	List list = infoDao.findAllDeliveryInfo(info.getUId());
%>
<form action="manage/doAddAddress.jsp?DUId=<%=info.getUId() %>" method="post">
	<div>
		<table width="100%" border="0" class="table1" cellpadding="10" cellspacing="0" style="border:solid #0066FF 1px;">
			<tr>
				<th colspan="4">已有的地址</th>
			</tr>
			<tr>
				<td colspan="4"><hr></td>
			</tr>
			...
			<%
				for(int i=0;i<list.size();i++){
					DeliveryInfo DInfo =(DeliveryInfo)list.get(i);
			%>
			<tr>
				<td align="center"><%=DInfo.getDName() %></td>
				<td align="center"><%=DInfo.getTel() %></td>
				<td align="center"><%=DInfo.getAddress() %></td>
				<%
					if(list.size()==1){
						out.print("<td>&nbsp;</td>");
					}else{
				...
				%>		
				<td align="center">
					<a href="manage/doDelAddress.jsp?DId=<%=DInfo.getDId() %>"><img src="image/del.gif" border="0" /></a>
				</td>
				<%
						}
				%>
		...
		<table width="100%" cellpadding="20" cellspacing="0" style="border:solid #0066FF 1px;">
			<tr>
				<th colspan="2" align="left"><br />添加收货地址</th>
			</tr>
			<tr>
				<td colspan="2"><hr /></td>
			</tr>
			<tr>
				<td width="10%">收货人：</td>
				<td width="90%"><input type="text" name="Name" id="Name" value="" /></td>
			</tr>
			<tr>
				<td>电&nbsp;&nbsp;话：</td>
			...
			<tr>
				<td>&nbsp;</td>
				<td><input type="submit" value="添 加" />&nbsp;&nbsp;&nbsp;&nbsp;<input type="reset" value="重 置" /></td>
			</tr>
		</table>
	</div>
</form>
