...
public class RegApi extends BaseDiguApi {
	...
	//必须用Post 方法，不需要认证。
	public String reg(EDataFormat edf,String username,String nickname,String pwd,String confirmPwd,String email) throws NoAuthException{
		String pattern=".{0}";
	...
	//验证用户名是否已经被注册，Get 请求。
	public String check(EDataFormat edf,String username) throws NoAuthException{
